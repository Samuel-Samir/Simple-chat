package com.example.ecss.medicalmapper.chatingSystem.ui;
...
import com.example.ecss.medicalmapper.chatingSystem.FireChatHelper.ExtraIntent;
import com.example.ecss.medicalmapper.chatingSystem.adapter.MessageChatAdapter;
import com.example.ecss.medicalmapper.chatingSystem.model.ChatMessage;
...
public class ChatActivity extends Activity {
    ...
    protected void onStart() {
        ...
        messageChatListener = messageChatDatabase.limitToFirst(20000).addChildEventListener(new ChildEventListener() {
            @Override
